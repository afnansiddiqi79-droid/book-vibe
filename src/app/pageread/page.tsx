...
const Pagereadpage = () => {
  ...
  const data = readBooks.map((book: IBook, ind) => {
    return {
      name: book.bookName,
      uv: book.totalPages,
      pv: ind + 1,
  ...
  return (
    <div className="container mx-auto flex items-center justify-center my-12 text-center">
      {readBooks.length > 0 ? (
        <BarChart
          style={{
            width: "100%",
        ...
        <p className="font-bold my-6 text-4xl text-center">
